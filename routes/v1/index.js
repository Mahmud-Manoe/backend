...
v1.get(
  "/achievement/materials/:id",
  AchievementController.getAchievementByMaterialId
);
...
v1.get(
  "/answers/user",
  [Authentication.requiredToken, Authentication.isStudent],
  AnswerController.getAnswerByUser
);
...
v1.post(
  "/class",
  [Authentication.requiredToken, Authentication.isTeacher],
  kelasController.buatkelas
); //guru
v1.get(
  "/classes/all",
  [Authentication.requiredToken, Authentication.isAdmin],
  kelasController.lihatKelas
); //admin
v1.get(
  "/class/:id",
...
v1.get(
  "/classes/teacher",
  [Authentication.requiredToken, Authentication.isTeacher],
  kelasController.kelasGuru
);
v1.get(
  "/classes/student",
  [Authentication.requiredToken, Authentication.isStudent],
  kelasController.kelasSiswa
);
v1.put(
  "/kelas/:id",
  [Authentication.requiredToken, Authentication.isTeacher],
  kelasController.updateKelasById
); //guru
v1.delete(
  "/kelas/:id",
  [Authentication.requiredToken, Authentication.isTeacher],
  kelasController.hapusKelas
); //admin
...
v1.delete(
  "/invitation/classes/:id",
  InvitationController.deleteInvitationByClass
); //guru
...
v1.get(
  "/students/classes",
  [Authentication.requiredToken, Authentication.isStudent],
  StudentController.getClassesStudent
);
v1.post(
  "/student",
  [Authentication.requiredToken, Authentication.isStudent],
...
v1.delete(
  "/student",
  [Authentication.requiredToken, Authentication.isStudent],
  StudentController.deleteStudentByUser
); //siswa
